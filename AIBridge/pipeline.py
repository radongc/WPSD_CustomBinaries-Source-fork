...
class ClaudeLLM:
    ...
    system_prompt: str = (
        ...
        "Unit IDs should be formatted as a space or dash-separated string of digits to work with the text-to-speech model. For example, the unit ID 1234567 should be formatted like 1-2-3-4-5-6-7 or 1 2 3 4 5 6 7 in responses - not 1234567."
